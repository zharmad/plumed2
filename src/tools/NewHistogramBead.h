...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_tools_NewHistogramBead_h
#define __PLUMED_tools_NewHistogramBead_h
...
public:
	...
	double setBoundsAndCalculate(const double& , const double& , const double& x, double& df) const;
        double boundDerivative( const double& lowb, const double& x ) const;
        double getDMax() const ;
};	

inline
bool NewHistogramBead::hasBeenSet() const {
  return init;
}

inline
void NewHistogramBead::isNotPeriodic(){
  periodicity=notperiodic;
}

inline
void NewHistogramBead::isPeriodic( const double& mlow, const double& mhigh ){
...
inline
double NewHistogramBead::difference( const double& d1, const double& d2 ) const {
...
inline
double NewHistogramBead::getDMax() const {
  return sf.get_dmax();
}
